        ...
        <label className="grid gap-2">
          ...
          <span className="relative block">
            ...
            <input
              ...
              className="h-[45px] w-full rounded-[6px] border border-[#d9deea] bg-white pl-11 pr-4 text-[14px] font-medium text-[#070b16] outline-none transition placeholder:text-[#7a8297] focus:border-[#58d83f] focus:ring-4 focus:ring-[#58d83f]/20 dark:border-white/12 dark:bg-[#151719] dark:text-white dark:placeholder:text-zinc-500"
            />
          </span>
        </label>
        ...
        <label className="grid gap-2">
          <span className="flex items-center justify-between gap-4 text-[13px] font-bold text-[#070b16] dark:text-white">
            ...
            <a
              ...
              className="text-[12px] font-semibold text-[#11952f] transition hover:text-[#086d22]"
            >
              Forgot password?
            </a>
          </span>
          <span className="relative block">
            ...
            <input
              ...
              className="h-[45px] w-full rounded-[6px] border border-[#d9deea] bg-white pl-11 pr-11 text-[14px] font-medium text-[#070b16] outline-none transition placeholder:text-[#7a8297] focus:border-[#58d83f] focus:ring-4 focus:ring-[#58d83f]/20 dark:border-white/12 dark:bg-[#151719] dark:text-white dark:placeholder:text-zinc-500"
            />
            <button
              type="button"
      ...
      <div className="mt-7">
        <label className="flex items-center gap-3 text-[13px] font-medium text-[#596176] dark:text-zinc-300">
          <Checkbox
            ...
            className="size-4 rounded-[4px] border-[#cbd2df] bg-white data-checked:border-[#0d8d2d] data-checked:bg-[#0d8d2d] data-checked:text-white"
          />
        ...
        >
          ...
          <div className="mt-[112px]">
            ...
            <p className="mt-5 max-w-[385px] text-[14px] font-medium leading-6 text-white/88">
              Sign in to your seller dashboard and manage your store with ease.
            </p>
          </div>
