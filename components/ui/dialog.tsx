...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "shrink-0 flex flex-col-reverse gap-2 border-t border-slate-200/80 bg-slate-50/80 p-4 sm:flex-row sm:justify-end dark:border-white/10 dark:bg-white/[0.03]",
        className
      )}
      {...props}
    >
